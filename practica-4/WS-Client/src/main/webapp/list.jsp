    ...
    <body>
        ...
        <div class="container"> 
             ...
             <%
                ...
                /* Prepare GET request */
                String sUrl = "http://192.168.245.56:8080/WS-Backend/resources/jakartaee9/list";
                ...
                if(result!=null){
                  ...
                  for (int i = 0; i < total; ++i) {
                    ...
                    out.println("<div class=\"image\"> <img src='http://192.168.245.56:8080/PRACTICA2/images/"+imageInfo[8]+"' alt="+imageInfo[5]+" longdesc="+i+"/> </div>"); //alt = creador de la imagen ; longdesc = posicion en la lista. 
                  } 
