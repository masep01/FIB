...
public class OperateDB {
    ...
    public static boolean insert_image(String title, String description, String keywords, 
            String author, String creator, String cDate,String sDate, Part filePart, 
            Connection connection){ 
        String filename = null;
        try {
           
            String original = Paths.get(filePart.getSubmittedFileName()).getFileName().toString();      // Retrieve filename
