        ...
        if(session == null) 
        {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                if (iInfo == null) {
                    ...
                    String id = iInfo[0]; 
                    String fileName = iInfo[8]; 
                     System.out.print(fileName);
                    /* Delete local image */
                    File file = new File("/var/webapp/images/client/"+fileName+"");
                    file.delete();
                    ...
                    URL url = new URL("http://192.168.245.56:8080/WS-Backend/resources/jakartaee9/delete");
