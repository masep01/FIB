    ...
    <body>
        ...
        <div class="container"> 
             ...
             <%
                ...
                /* Prepare GET request */
                String sUrl = "http://localhost:8080/WS-Backend/resources/jakartaee9/list";
                ...
                if(result!=null){
                    Gson gson = new Gson();
                    List<String[]> imageList = gson.fromJson(result, new TypeToken<List<String[]>>(){}.getType());
                  ...
                  for (int i = 0; i < total; ++i) {
                    ...
                    out.println("<div class=\"image\"> <img src='https://uvn-brightspot.s3.amazonaws.com/assets/vixes/f/foca-bebe-cria-de-foca-sobre-hielo-04.jpg' alt="+imageInfo[5]+" longdesc="+i+"/> </div>"); //alt = creador de la imagen ; longdesc = posicion en la lista. 
                  } 
                            
                }
                        
                else {
                    session.setAttribute("errorMessage", "Error listing images");
                    response.sendRedirect("error.jsp"); 
                }
             %>
             </div>  
