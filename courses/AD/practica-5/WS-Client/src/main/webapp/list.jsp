    ...
    <body>
        ...
        <div class="container"> 
             ...
             <%
                ...
                /* Prepare GET request */
                String sUrl = "http://localhost:8000/list";
                ...
                if(result!=null){
                  ...
                  for (int i = 0; i < total; ++i) {
                    ...
                    out.println("<div class=\"image\"> <img src='http://localhost:8080/WS-Client/images/"+imageInfo[8]+"' alt="+imageInfo[5]+" longdesc="+i+"/> </div>"); //alt = creador de la imagen ; longdesc = posicion en la lista. 
                  } 
