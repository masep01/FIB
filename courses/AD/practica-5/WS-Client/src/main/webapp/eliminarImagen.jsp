        ...
        <div class="main"> 
            <div class="container"> 
                ...
                <div class="imageWrapper">
                    <%
                        String baseUrl = "http://localhost:8000/download";
                        ...
                        if(downloadConnection.getResponseCode() != 500){
                        ...
                        out.print("<img id='image' src='http://localhost:8080/WS-Client/client/"+imageInfo[8]+"' width='300px'/>"); 
                    %>
                    <table id="tabla">
                        <tr>
                            <th>TITLE</th> 
